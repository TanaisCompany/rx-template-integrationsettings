...
С версии 25.1 добавлены:
- справочник "Интегрируемые типы сущности"
- абстрактный справочник "Элементы очереди синхронизации"
- справочник "Элементы очереди синхронизации"
...
> [!NOTE]
>
> Замечания и пожеланию по развитию шаблона разработки фиксируйте через [Issues](https://github.com/DirectumCompany/rx-template-integrationsettings/issues).
>
...
4. В справочник Интегрируемые типы сущности добавить синхронизируемые типы сущностей.
   - Решаемая задача:
	 - синхронизация выделенных типов сущностей.
5. От абстрактного справочника "Элементы очереди синхронизации" создать дополнительные очереди для обработки синхронизируемых сущностей либо воспользоваться реализованным справочником "Элементы очереди синхронизации"
   - Решаемая задача:
     разделение потоков синхронизируемых сущностей.
